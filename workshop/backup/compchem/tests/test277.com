...
iop(10/29=2,10/31=1) fmm int=nogather
...
%mem=1000000,6000000
#p svwn5/6-31G(df,p) 5d 7f test geom=modela freq scf=noincore
iop(10/31=1,10/29=3) iop1=nodftj
...
%mem=1000000,6000000
#p svwn5/6-31G(df,p) 5d 7f test geom=modela freq scf=noincore raff
iop(10/31=1) int=nogather iop1=nodftj
...
%mem=1000000,6000000
#p svwn5/6-31G(df,p) 5d 7f test geom=modela freq scf=noincore
iop(10/31=1,10/29=3) int=nogather iop1=nodftj
