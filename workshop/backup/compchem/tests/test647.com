...
Delta excited state of BH with D95**. All the SCF MOs are included
in the active space (default of SAC-CI optimization). Initial
...
Delta excited state of BH with full-active MOs of D95**.
