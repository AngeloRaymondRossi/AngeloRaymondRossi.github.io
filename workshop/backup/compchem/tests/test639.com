...
ground state of NH2 with D95(d) basis. MOD method is used and all
the SCF MOs are included in the active space. MacroIter=1.
...
excited state of NH2 with full-active MOs of D95(d) basis.
