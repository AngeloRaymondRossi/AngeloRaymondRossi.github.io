%mem=32mw
%chk=test576
#p oniom(hf/6-31g**:hf/sto-3g)=compress opt freq test 5d

Gaussian Test Job 576 (Part 1):
Neopentane 
...
%mem=32mw
%chk=test576
#p oniom(hf/6-31g**:hf/sto-3g)=compress freq test geom=check guess=read 5d iop(11/43=3)

Gaussian Test Job 576 (Part 2):
Neopentane 
