...
# SAC-CI(Singlet=(NState=1,Variational),
        FullActive,LMO=PM,BGSUM)/3-21G Nosymmetry test

Gaussian Test Job 659 (Part 1):
Point no.1 of potential energy curve of singlet A' excited state of
HCN with respect to H-C-N valence angle. Full-active MOs are used
for the geometry optimization. LMOs are used as reference MOs.
...
%chk=test659
# SAC-CI(Singlet=(NState=1,Variational),
        FullActive,CGSUM)/3-21G Nosymmetry test
...
# SAC-CI(Singlet=(NState=1,Variational),
        ...
        FullActive,AGSUM)/3-21G Opt=ModRedundant Nosymmetry test
