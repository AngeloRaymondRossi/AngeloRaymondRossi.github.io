%chk=test154
#P RHF/4-31G NOPOP NAME=INTQN test int=nosp scf=conventional
...
KERTESZ QUINOID GEO OF INT DIMER, forcing l311
...
%chk=test154
%nosave
#P RHF/4-31G NOPOP NAME=INTQN test geom=check guess=read
scf=(direct,nofinal,tight)

Gaussian Test Job 154 (Part 3):
