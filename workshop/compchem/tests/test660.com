%mem=12mw
# SAC-CI(Quartet=(NState=(0,1,0,0,0,0,0,0),Variational),
...
DT-R method (V/NV Iterative/InCoreDiag) with full-active MOs of D95,
MOD(CMO) method is used.
...
--Link1--
%mem=12mw
# SAC-CI(Quartet=(NState=(0,1,0,0,0,0,0,0),Variational,InCoreDiag),
        Targetstate=(SpinState=Quartet,Symmetry=2,Root=1),
...
--Link1--
%mem=12mw
# SAC-CI(Quartet=(NState=(0,1,0,0,0,0,0,0),NonVariational,Iterative),
        Targetstate=(SpinState=Quartet,Symmetry=2,Root=1))
       /D95 Opt test
...
--Link1--
%mem=12mw
# SAC-CI(Quartet=(NState=(0,1,0,0,0,0,0,0),NonVariational,InCoreDiag),
        Targetstate=(SpinState=Quartet,Symmetry=2,Root=1),
        InCoreSAC)/D95 Opt test
