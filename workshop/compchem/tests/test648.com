...
the quartet Sigma_g- state of C2+ with D95**. All the SCF MOs are
included in the active space; default of SAC-CI optimization.
...
SAC-CI high-spin (DT-R) geometry optimization calculation for
the quartet Sigma_u- state of C2+ with full-active MOs of D95**.
Initial geometry is the experimental one.
...
the quartet Sigma_g- state of C2+ with full-active MOs of D95**.
Initial geometry is the experimental one.
