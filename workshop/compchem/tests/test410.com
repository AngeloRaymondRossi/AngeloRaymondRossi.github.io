%chk=test410
#p opt freq oniom(hf/sto-3g:am1) test
...
--Link1--
%chk=test410
#p freq=numer oniom(hf/sto-3g:am1) test geom=check guess=read
...
%chk=test410
%nosave
#p freq=enonly oniom(hf/sto-3g:am1) test geom=check guess=read
